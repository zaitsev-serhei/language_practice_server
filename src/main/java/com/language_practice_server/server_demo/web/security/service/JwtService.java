...
public class JwtService {
    ...
    private String buildToken(
        ...
        return Jwts
                ...
                .setSubject(userDetails.getUsername()) // add claims for user_id to use in SecurityAuditorAware class for auto complete entity fields (createdBy, CreatedAt etc.)
